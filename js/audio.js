...
(function (root) {
  ...
  class AudioBus {
    constructor() {
      ...
      this._banks = {
        ugh: {
          paths: ["assets/sfx/ugh.mp3", "assets/sfx/ugh-2.mp3", "assets/sfx/ugh-3.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        pan: {
          paths: ["assets/sfx/pan-ping.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        drop: {
          paths: [
            "assets/sfx/drop-1.mp3",
            "assets/sfx/drop-2.mp3",
            "assets/sfx/drop-3.mp3",
            "assets/sfx/drop-4.mp3",
          ],
          raw: [],
          bufs: [],
          last: -1,
        ...
        gun: {
          paths: [
            "assets/sfx/gun-1.mp3",
            "assets/sfx/gun-2.mp3",
            "assets/sfx/gun-3.mp3",
            "assets/sfx/gun-4.mp3",
          ],
          raw: [],
          bufs: [],
          last: -1,
        ...
        wood: {
          paths: ["assets/sfx/wood-1.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        cock: {
          paths: ["assets/sfx/cock-1.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        plate: {
          paths: ["assets/sfx/plate-1.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        barrel: {
          paths: ["assets/sfx/barrel-1.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
        wind: {
          paths: ["assets/sfx/wind-1.mp3"],
          raw: [],
          bufs: [],
          last: -1,
        },
